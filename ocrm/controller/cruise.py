...
from ocrm.services.cruise_service import add_cruise_categories, add_cruise_participants, add_cruise_closing_details, add_cruise_histories, add_cruise_flats, add_cruise_options, add_cruise_prices, add_cruise_flight_details
...
def create_order(external_order):
    ...
    try:
        ...
        # add cruise flight details
        add_cruise_flight_details(order, flight_detail)
